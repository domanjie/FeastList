...
export const TrayActive = () => {
  return (
    ...
    >
      <path
        fill="#FFCF0D"
        d="M9.572 16.888H30.92c.891 0 1.677-.672 1.93-1.651l2.272-8.8c.245-.954-.378-1.91-1.246-1.91H6.768l2.803 12.361z"
      ></path>
      <path
        fill="#000"
        d="M31.126 22.59H10.712c-.267 0-.5-.207-.567-.503L5.778 2.832c-.163-.721-.732-1.225-1.383-1.225H.763c-.324 0-.586-.3-.586-.671 0-.37.262-.672.586-.672h3.632c1.185 0 2.22.918 2.518 2.231l4.253 18.752h19.96c.324 0 .587.301.587.672 0 .37-.263.671-.587.671zM27.088 30.264c-1.402 0-2.542-1.306-2.542-2.911s1.14-2.911 2.542-2.911 2.542 1.306 2.542 2.91c0 1.606-1.14 2.912-2.542 2.912zm0-4.808c-.914 0-1.657.85-1.657 1.897 0 1.046.743 1.897 1.657 1.897s1.657-.85 1.657-1.897c0-1.046-.743-1.897-1.657-1.897zM14.291 30.07c-1.402 0-2.542-1.307-2.542-2.913 0-1.605 1.14-2.91 2.542-2.91s2.543 1.305 2.543 2.91c0 1.606-1.14 2.912-2.543 2.912zm0-4.81c-.913 0-1.657.851-1.657 1.897 0 1.047.744 1.898 1.657 1.898.914 0 1.657-.851 1.657-1.898 0-1.046-.743-1.897-1.657-1.897z"
      ></path>
    </svg>
  )
}
export const TrayInActive = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="36"
    ...
    >
      <path
        fill="#000"
        d="M34.909 4.444c-.336-.519-.85-.816-1.411-.816H7.044l-.326-1.45C6.436.921 5.453.042 4.328.042H.736C.473.042.26.288.26.592c0 .302.213.548.475.548H4.33c.692 0 1.296.54 1.47 1.314l4.32 19.218c.055.241.244.41.46.41h20.198c.263 0 .475-.245.475-.548 0-.304-.212-.549-.475-.549h-19.83l-.883-3.923h20.51c1.084 0 2.057-.84 2.364-2.041l2.248-8.783c.16-.62.058-1.275-.277-1.794zm-.633 1.483l-2.248 8.783c-.19.74-.787 1.255-1.454 1.255H9.817L7.291 4.725h26.207c.258 0 .495.138.65.376.154.239.2.54.128.826zM14.073 30.043c-1.505 0-2.728-1.414-2.728-3.152 0-1.737 1.223-3.15 2.728-3.15 1.504 0 2.728 1.413 2.728 3.15 0 1.738-1.224 3.152-2.728 3.152zm0-5.205c-.98 0-1.778.921-1.778 2.053 0 1.133.797 2.054 1.778 2.054.98 0 1.778-.921 1.778-2.054 0-1.132-.798-2.053-1.778-2.053zM26.764 30.043c-1.504 0-2.728-1.414-2.728-3.152 0-1.737 1.224-3.15 2.728-3.15 1.504 0 2.728 1.413 2.728 3.15 0 1.738-1.224 3.152-2.728 3.152zm0-5.205c-.98 0-1.778.921-1.778 2.053 0 1.133.798 2.054 1.778 2.054s1.778-.921 1.778-2.054c0-1.132-.798-2.053-1.778-2.053z"
      ></path>
    </svg>
  )
}
